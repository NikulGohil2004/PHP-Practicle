    ...
    <div class="card card-info card-outline mb-4 mt-4 w-50">
       ...
       class="form-control">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lastName" class="form-control"    value="<?= htmlspecialchars($old['lastName'] ?? '') ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="confirmPassword" class="form-control"    value="<?= htmlspecialchars($old['confirmPassword'] ?? '') ?>">
                    </div>
