...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td><img src='upload/{$row['filenam']}' class='rounded' width='100' height='100' ></td>";
    echo "<td><button class='btn btn-warning'><a href=\"UpdateDas.php?id=" .$row["id"] ."\">Update</a></button></td>";
